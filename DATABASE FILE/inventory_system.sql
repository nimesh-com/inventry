...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 17, 2026 at 04:45 AM
...
--
-- Table structure for table `transport_stock`
--

CREATE TABLE `transport_stock` (
  `id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `product_name` varchar(255) NOT NULL,
...
(1, 'Admin', 'Admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 1, 'no_image.png', 1, '2026-03-17 09:13:28'),
...
--
-- Indexes for table `transport_stock`
--
ALTER TABLE `transport_stock`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `transport_stock`
--
ALTER TABLE `transport_stock`
